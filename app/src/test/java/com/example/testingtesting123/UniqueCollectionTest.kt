...
class UniqueCollectionTest {
    ...
    fun addAnItem() {
        ...
        assert(collection.size() == 1) { "Item not added successfully" }
    }
    ...
    fun addUniqueItem() {
        collection.addItem(Item("item1"))
        collection.addItem(Item("Item1")) // Should not be added due to case-insensitive equality
        assert(collection.size() == 1) { "Duplicate item added" }
    }
